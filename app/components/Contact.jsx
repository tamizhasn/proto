...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "d097b731-b539-4034-99f2-f911f4b4b97f");
  ...
  return (
    <div id='contact' className='relative z-10 w-full px-[12%] py-20 scroll-mt-20 bg-[url("/footer-bg-color.png")] 
