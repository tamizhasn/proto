    ...
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className='text-center text-5xl font-Ovo'>
        ...
        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            ...
            showcasing my expertise in Software Development</p>
            ...
            {workData.map((project, index)=>(
                ...
                style={{backgroundImage: `url(${project.bgImage})`}}>
                    ...
                    duration-500 group-hover:bottom-7'>
                        ...
                        aspect-square flex items-center justify-center shadow-[2px_spx_0_#000] 
        ...
        my-20 hover:bg-lightHover duration-500'>
           Show more <Image src={assets.right_arrow_bold} alt='Rigth arrow'
           className='w-4' />
        </a>
    </div>
  )
